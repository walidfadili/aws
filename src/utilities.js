...
const detectRot = (keypoints)=> {
    var distanceRight= keypoints[454][0]-keypoints[5][0]
    var distanceLeft= keypoints[5][0]-keypoints[234][0]
    var distanceAbsoluteHorizental= keypoints[454][0]-keypoints[234][0]
    var ratioRight= distanceRight/distanceAbsoluteHorizental
    var ratioLeft= distanceLeft/distanceAbsoluteHorizental
    var ratioVertical= (keypoints[10][1]-keypoints[5][1])/(keypoints[10][1]-keypoints[152][1])
    var ratioIrisHorizental= (keypoints[473][0]-keypoints[133][0])/(keypoints[133][0]-keypoints[130][0])
    var ratioIrisVertical= (keypoints[473][1]-keypoints[159][1])/(keypoints[159][1]-keypoints[145][1])
    return [
        ratioRight,
        ratioLeft,
        ratioVertical,
...
export const drawMesh = (predictions, ctx) => {
  ...
  if (predictions.length > 0) {
   ...
   /* else if (Math.abs(response[4])<0.4){
      ...
      //console.log(detectRot(keypoints))
